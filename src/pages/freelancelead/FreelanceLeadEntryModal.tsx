...
export function FreelanceLeadEntryModal({
  open,
  onClose,
  onSave,
  initialData,
  isSubmitting = false,
}: FreelanceLeadEntryModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="e.g. Acme Corp / Grand Hotel Project"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. Downtown / West Tech Park"

...
const navItems: { id: TripoLeadTab; label: string; icon: any; color: string; activeText: string; activeBg: string }[] = [
  {
    id: 'home',
    label: 'Home',
    icon: Home,
...
export function TripoLeadMobileBottomNav({ activeTab, onTabChange }: TripoLeadMobileBottomNavProps) {
  return (
    <nav
      ...
      aria-label="TripO Lead Mobile Bottom Navigation"
    >
      {navItems.map((item) => {

...
interface TripoLeadCreateFolderModalProps {
  open: boolean;
  onClose: () => void;
...
export function TripoLeadCreateFolderModal({
  open,
  onClose,
  onSave,
  isSubmitting = false,
}: TripoLeadCreateFolderModalProps) {
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-[var(--color-text-secondary)] mt-0.5">
                Enter a folder name for your TripO files
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="e.g. Website Leads, Client Documents"

...
export type FreelanceLeadTab = 'home' | 'files' | 'starred' | 'recent' | 'trash';

interface FreelanceLeadSidebarProps {
  isOpen: boolean;
  onClose: () => void;
...
const navItems: { id: FreelanceLeadTab; label: string; icon: any; color: string; bg: string }[] = [
...
export function FreelanceLeadSidebar({ isOpen, onClose, activeTab, onTabChange }: FreelanceLeadSidebarProps) {
